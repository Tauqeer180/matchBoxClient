  ...
  return (
    <Suspense fallback={<Loading cover="page" />}>
      <Switch>
        ...
        />
        <Route
          path={`${AUTH_PREFIX_PATH}/login_wh`}
          component={lazy(() => import(`./authentication/login_wh`))}
        />
        <Route
        ...
        />
        <Route
          path={`${AUTH_PREFIX_PATH}/thankyou`}
          component={lazy(() => import(`./authentication/thankyou`))}
        />
        <Route
